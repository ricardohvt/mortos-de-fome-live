...
<body>
  ...
  <section class="main-modal">
    <section class="modal-content">
      ...
      <form action="../controller/RecuperacaoEmailController.php" method="POST" class="main-form">
        ...
        <div class="content">
          ...
          <label for="email">
            <p>Email:</p>
            <input required type="email" name="email" id="input-username" class="input-username input" placeholder="Email do usuário"><br>
          </label>
          <hr>
          <?php
          ...
          <div class="button-main">
            <button class="button-submit btn-r">Prosseguir</button>
          </div>
      </form>
      </div>
    </section>
